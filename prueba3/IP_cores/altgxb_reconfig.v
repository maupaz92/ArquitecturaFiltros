...
//VERSION_BEGIN 15.1 cbx_alt_dprio 2015:10:21:18:09:22:SJ cbx_cycloneii 2015:10:21:18:09:23:SJ cbx_lpm_add_sub 2015:10:21:18:09:23:SJ cbx_lpm_compare 2015:10:21:18:09:23:SJ cbx_lpm_counter 2015:10:21:18:09:23:SJ cbx_lpm_decode 2015:10:21:18:09:23:SJ cbx_lpm_shiftreg 2015:10:21:18:09:23:SJ cbx_mgl 2015:10:21:18:12:49:SJ cbx_nadder 2015:10:21:18:09:23:SJ cbx_stratix 2015:10:21:18:09:23:SJ cbx_stratixii 2015:10:21:18:09:23:SJ  VERSION_END
...
module  altgxb_reconfig_alt_dprio_q9l
	( 
	address,
	busy,
	datain,
...
endmodule //altgxb_reconfig_alt_dprio_q9l
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altgxb_reconfig_mux_cda
	( 
	data,
	result,
	sel) ;
...
`endif
	...
	wire  [2:0]  sel_node;
	wire  [7:0]  w_data1098w;
	wire  [3:0]  w_data1118w;
	wire  [3:0]  w_data1119w;
	wire  [7:0]  w_data1167w;
	wire  [3:0]  w_data1187w;
	wire  [3:0]  w_data1188w;
	wire  [7:0]  w_data1234w;
	wire  [3:0]  w_data1254w;
	wire  [3:0]  w_data1255w;
	wire  [7:0]  w_data1301w;
	wire  [3:0]  w_data1321w;
	wire  [3:0]  w_data1322w;
	wire  [7:0]  w_data1368w;
	wire  [3:0]  w_data1388w;
	wire  [3:0]  w_data1389w;
	wire  [7:0]  w_data1435w;
	wire  [3:0]  w_data1455w;
	wire  [3:0]  w_data1456w;
	wire  [1:0]  w_sel1120w;
	wire  [1:0]  w_sel1189w;
	wire  [1:0]  w_sel1256w;
	wire  [1:0]  w_sel1323w;
	...
	assign
		result = result_node,
		result_node = {((sel_node[2] & (((w_data1456w[1] & w_sel1457w[0]) & (~ (((w_data1456w[0] & (~ w_sel1457w[1])) & (~ w_sel1457w[0])) | (w_sel1457w[1] & (w_sel1457w[0] | w_data1456w[2]))))) | ((((w_data1456w[0] & (~ w_sel1457w[1])) & (~ w_sel1457w[0])) | (w_sel1457w[1] & (w_sel1457w[0] | w_data1456w[2]))) & (w_data1456w[3] | (~ w_sel1457w[0]))))) | ((~ sel_node[2]) & (((w_data1455w[1] & w_sel1457w[0]) & (~ (((w_data1455w[0] & (~ w_sel1457w[1])) & (~ w_sel1457w[0])) | (w_sel1457w[1] & (w_sel1457w[0] | w_data1455w[2]))))) | ((((w_data1455w[0] & (~ w_sel1457w[1])) & (~ w_sel1457w[0])) | (w_sel1457w[1] & (w_sel1457w[0] | w_data1455w[2]))) & (w_data1455w[3] | (~ w_sel1457w[0])))))), ((sel_node[2] & (((w_data1389w[1] & w_sel1390w[0]) & (~ (((w_data1389w[0] & (~ w_sel1390w[1])) & (~ w_sel1390w[0])) | (w_sel1390w[1] & (w_sel1390w[0] | w_data1389w[2]))))) | ((((w_data1389w[0] & (~ w_sel1390w[1])) & (~ w_sel1390w[0])) | (w_sel1390w[
_sel1189w[1] & (w_sel1189w[0] | w_data1187w[2]))))) | ((((w_data1187w[0] & (~ w_sel1189w[1])) & (~ w_sel1189w[0])) | (w_sel1189w[1] & (w_sel1189w[0] | w_data1187w[2]))) & (w_data1187w[3] | (~ w_sel1189w[0])))))), ((sel_node[2] & (((w_data1119w[1] & w_sel1120w[0]) & (~ (((w_data1119w[0] & (~ w_sel1120w[1])) & (~ w_sel1120w[0])) | (w_sel1120w[1] & (w_sel1120w[0] | w_data1119w[2]))))) | ((((w_data1119w[0] & (~ w_sel1120w[1])) & (~ w_sel1120w[0])) | (w_sel1120w[1] & (w_sel1120w[0] | w_data1119w[2]))) & (w_data1119w[3] | (~ w_sel1120w[0]))))) | ((~ sel_node[2]) & (((w_data1118w[1] & w_sel1120w[0]) & (~ (((w_data1118w[0] & (~ w_sel1120w[1])) & (~ w_sel1120w[0])) | (w_sel1120w[1] & (w_sel1120w[0] | w_data1118w[2]))))) | ((((w_data1118w[0] & (~ w_sel1120w[1])) & (~ w_sel1120w[0])) | (w_sel1120w[1] & (w_sel1120w[0] | w_data1118w[2]))) & (w_data1118w[3] | (~ w_sel1120w[0]))))))},
		sel_ffs_wire = {sel[2:0]},
		sel_node = {sel_ffs_wire[2], sel[1:0]},
		w_data1098w = {{2{1'b0}}, data[30], data[24], data[18], data[12], data[6], data[0]},
		w_data1118w = w_data1098w[3:0],
		w_data1119w = w_data1098w[7:4],
		w_data1167w = {{2{1'b0}}, data[31], data[25], data[19], data[13], data[7], data[1]},
		w_data1187w = w_data1167w[3:0],
		w_data1188w = w_data1167w[7:4],
		w_data1234w = {{2{1'b0}}, data[32], data[26], data[20], data[14], data[8], data[2]},
		w_data1254w = w_data1234w[3:0],
		w_data1255w = w_data1234w[7:4],
		w_data1301w = {{2{1'b0}}, data[33], data[27], data[21], data[15], data[9], data[3]},
		w_data1321w = w_data1301w[3:0],
		w_data1322w = w_data1301w[7:4],
		w_data1368w = {{2{1'b0}}, data[34], data[28], data[22], data[16], data[10], data[4]},
		w_data1388w = w_data1368w[3:0],
		w_data1389w = w_data1368w[7:4],
		w_data1435w = {{2{1'b0}}, data[35], data[29], data[23], data[17], data[11], data[5]},
		w_data1455w = w_data1435w[3:0],
		w_data1456w = w_data1435w[7:4],
		w_sel1120w = sel_node[1:0],
		w_sel1189w = sel_node[1:0],
		w_sel1256w = sel_node[1:0],
		w_sel1323w = sel_node[1:0],
		w_sel1390w = sel_node[1:0],
		w_sel1457w = sel_node[1:0];
endmodule //altgxb_reconfig_mux_cda
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altgxb_reconfig_mux_8da
	( 
	data,
	result,
	sel) ;
...
`endif
	...
	wire  [3:0]  w_data1535w;
	wire  [3:0]  w_data1560w;
	wire  [3:0]  w_data1585w;
	wire  [3:0]  w_data1610w;

	assign
		result = result_node,
		result_node = {(((w_data1610w[1] & sel_node[0]) & (~ (((w_data1610w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1610w[2]))))) | ((((w_data1610w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1610w[2]))) & (w_data1610w[3] | (~ sel_node[0])))), (((w_data1585w[1] & sel_node[0]) & (~ (((w_data1585w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1585w[2]))))) | ((((w_data1585w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1585w[2]))) & (w_data1585w[3] | (~ sel_node[0])))), (((w_data1560w[1] & sel_node[0]) & (~ (((w_data1560w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1560w[2]))))) | ((((w_data1560w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1560w[2]))) & (w_data1560w[3] | (~ sel_node[0])))), (((w_data1535w[1] & sel_node[0]) & (~ (((w_data1535w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1535w[2]))))) | ((((w_data1535w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1535w[2]))) & (w_data1535w[3] | (~ sel_node[0])))), (((w_data1505w[1] & sel_node[0]) & (~ (((w_data1505w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1505w[2]))))) | ((((w_data1505w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1505w[2]))) & (w_data1505w[3] | (~ sel_node[0]))))},
		sel_node = {sel[1:0]},
		w_data1505w = {data[15], data[10], data[5], data[0]},
		w_data1535w = {data[16], data[11], data[6], data[1]},
		w_data1560w = {data[17], data[12], data[7], data[2]},
		w_data1585w = {data[18], data[13], data[8], data[3]},
		w_data1610w = {data[19], data[14], data[9], data[4]};
endmodule //altgxb_reconfig_mux_8da

//synthesis_resources = alt_cal_c3gxb 1 lpm_add_sub 1 lpm_compare 21 lpm_counter 3 lpm_decode 2 lut 41 reg 163 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
module  altgxb_reconfig_alt_c3gxb_reconfig_u651
	( 
	busy,
...
`endif
	...
	altgxb_reconfig_alt_dprio_q9l   dprio
	( 
	...
	altgxb_reconfig_mux_cda   central_pcs_first_word_mux
	( 
	...
	altgxb_reconfig_mux_8da   max_word_per_mif_type
	( 
...
endmodule //altgxb_reconfig_alt_c3gxb_reconfig_u651
//VALID FILE
...
`endif
	...
	wire [0:0] sub_wire0 = 1'h1;
	wire [0:0] sub_wire2 = 1'h0;
	wire  sub_wire3;
	wire  sub_wire4;
	wire [5:0] sub_wire5;
	wire [3:0] sub_wire6;
	wire [2:0] sub_wire1 = {sub_wire2, sub_wire2, sub_wire0};
	wire  busy = sub_wire3;
	wire  channel_reconfig_done = sub_wire4;
	wire [5:0] reconfig_address_out = sub_wire5[5:0];
	wire [3:0] reconfig_togxb = sub_wire6[3:0];

	altgxb_reconfig_alt_c3gxb_reconfig_u651	altgxb_reconfig_alt_c3gxb_reconfig_u651_component (
				.offset_cancellation_reset (offset_cancellation_reset),
				.reconfig_clk (reconfig_clk),
				.reconfig_data (reconfig_data),
				.reconfig_fromgxb (reconfig_fromgxb),
				.reconfig_mode_sel (sub_wire1),
				.reconfig_reset (reconfig_reset),
				.write_all (write_all),
				.busy (sub_wire3),
				.channel_reconfig_done (sub_wire4),
				.reconfig_address_out (sub_wire5),
				.reconfig_togxb (sub_wire6))/* synthesis synthesis_clearbox=2
	 clearbox_macroname = alt_c3gxb_reconfig
	 clearbox_defparam = "cbx_blackbox_list=-lpm_mux;intended_device_family=Cyclone IV GX;mif_address_width=6;number_of_channels=1;number_of_reconfig_ports=1;enable_buf_cal=true;reconfig_fromgxb_width=5;reconfig_togxb_width=4;" */;
